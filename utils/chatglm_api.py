...
# your api key
zhipuai.api_key = "cb9395378786981cc3abb3f1202a49d3.8OAZgwkOOuxHNSNJ"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--host", type=str, default="10.96.42.224", help="host name")
    # parser.add_argument("--port", type=int, default=6000, help="port number")
    parser.add_argument("--port", type=int, default=6000, help="port number")

    args = parser.parse_args()
    uvicorn.run("chatglm_api:app", host=args.host, port=args.port, reload=False)
